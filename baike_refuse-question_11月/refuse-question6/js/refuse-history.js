...
if ($('.contrast_tit')[2]) {
  ...
  var word_id_wrap=$(word_name_wrap).find('a')[1];
  word_name=$(word_name_wrap).find("h1")[0].innerText;
  word_id=$(word_id_wrap).attr('href').split("&sp=")[1].split("l")[1];
}
...
console.log(word_name+word_id+editor_name+editor_id);
// 编辑人员名字和ID
...
//   // 向background.js发送消息
//   chrome.extension.sendMessage({review_flag:1,word_name:word_name,word_id:word_id,editor_name: editor_name,editor_id:editor_id,history_refuse:history_refuse});
// })
